...
object Utils {
  ...
  def commonRequest(url: String, proxy: (String, Int), cookie: String = "")(implicit headerHost: String, timeout: Int): Document = {
    logger.info(s"Begin to request $url with $proxy")
